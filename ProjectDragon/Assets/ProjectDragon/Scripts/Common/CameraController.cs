...
namespace Dragon
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        [field: SerializeField] public Cinemachine.CinemachineVirtualCamera FollowCamera { get; private set; }
        [field: SerializeField] public Cinemachine.CinemachineFreeLook FreeLookCamera { get; private set; }
